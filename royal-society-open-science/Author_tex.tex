...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=1\textwidth]{figs/SanctumPageEntryTransformationLogic.JPG}
	\caption{Sanctum Page Entry Transformation Logic in Rocket Core \cite{R5:6}}
\end{figure}

\begin{figure}[hbt!]
	\centering
	\includegraphics[width=1\textwidth]{figs/SanctumRoT.JPG}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=1\textwidth]{figs/SoftwareSecureBootFlow.JPG}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=1\textwidth]{figs/SystemPortMap-Original.JPG}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=1\textwidth]{figs/SecureBootUnsigned.JPG}
...
\begin{figure}[hbt!]
	\centering
	\includegraphics[width=1\textwidth]{figs/SecureBootSigned.JPG}
